...
TEXT_RULES = (
    ...
    "5. На фотографії має бути лише одне число, а не декілька. Обрізати фотографії заборонено.\n\n"
    "6. Якщо надіслане фото не відповідає завданню, його можна відмінити і почати раунд заново.\n\n"
